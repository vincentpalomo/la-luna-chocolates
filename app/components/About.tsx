  ...
  return (
    <section id="about" className="min-h-screen flex flex-col justify-center items-center p-5">
      <main className="sm:mx-10  mt-20">
        <div className="font-main font-semibold text-xl md:text-6xl leading-tight md:leading-[60px] tracking-[-3%] text-center max-w-[95vw] 2xl:text-[72px] 2xl:leading-[72px] sm:flex items-center justify-center mb-12 hidden">
